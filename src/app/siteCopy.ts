...
const siteCopy = {
  es: {
    ...
    quote: {
      ...
      name: "Nombre",
      phone: "Numero de teléfono personal o WhatsApp",
      ...
      eventType: {
        ...
        serenade: "Serenata romantica",
        wedding: "Boda",
        birthday: "Cumpleaños",
        proposal: "Propuesta",
        party: "Celebracion familiar o de amigos",
  ...
  en: {
    ...
    quote: {
      ...
      name: "Name",
      phone: "Personal phone number or WhatsApp",
      date: "Event date",
      time: "Time",
      ampm: {
        label: "AM/PM",
      ...
      eventType: {
        label: "Event type",
        serenade: "Romantic serenade",
        wedding: "Wedding",
        birthday: "Birthday",
        proposal: "Proposal",
        party: "Family or friends celebration",
